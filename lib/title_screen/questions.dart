...
class _Question {
  _Question(this.stage, this.question, this.answers);
  final FounderBackgroundStage stage;
  final String question;
  final List<_Option> answers;
}

class _Option {
  _Option(this.id, this.option, this.description, this.callback);
  final String id;
  final String option;
...
Future<void> characterCreationQuestions(Creature founder, bool choose) async {
  ...
  List<_Question> questions = [
    _Question(
      ...
      "In the moments after I was born in 2004...",
      [
        _Option(
          'iraq_torture_revealed',
        ...
        _Option(
          'massachusetts_marriage_equality',
    ...
    _Question(
      FounderBackgroundStage.parentsDivorce,
      "When I turned 10, my parents divorced.",
      [
        _Option(
          'acrimonious_divorce',
          "Acrimoniously.  I once tripped over the paperwork!",
          "+1 Law, +1 Agility",
          () {
        ...
        _Option(
          'continued_studies',
          "My studies suffered, but I continued working.",
          "+1 Computers, +1 Intelligence",
          () {
            founder.adjustSkill(Skill.computers, 1);
            founder.adjustAttribute(Attribute.intelligence, 1);
        ...
        _Option(
          'words_as_weapons',
          "This was when I began to understand that words were weapons.",
    ...
    _Question(FounderBackgroundStage.middleSchool, "In middle school...", [
      _Option(
        'punk_and_lockers',
        "I broke into lockers and was into punk rock.",
      ...
      _Option(
        'chess_engine',
        "I created my own chess engine.  I had no friends.",
    ...
    _Question(
      ...
      [
        ...
        _Option(
          'class_president_campaign',
          "so I ran for class president.  The campaign was a disaster.",
    ...
    _Question(
      FounderBackgroundStage.ranAway,
    ...
    _Question(
      FounderBackgroundStage.eighteenthBirthday,
      "Life went on.  On my 18th birthday...",
      [
        _Option(
          'stole_sports_car',
          "I stole a sports car.  The owner must have been pissed!",
        ...
        _Option(
          'bought_ak102',
          "I bought myself an assault rifle.  An AK-102.  Fully automatic.",
          "+1 Firearms, AK-102",
          () {
            founder.adjustSkill(Skill.firearms, 1);
        ...
        _Option(
          ...
          () {
            ...
            Iterable<Site> downtownSites =
                founder.base?.city.districts[1].sites.where(
                  (s) => s.type != SiteType.oubliette,
                ) ??
                [];
        ...
        _Option(
          ...
          () {
            ...
            Creature lawyer = Creature.fromId(
            ...
            lawyer.juice = 100;
            lawyer.birthDate = gameState.date.subtract(
              Duration(days: 365 * 25 + lcsRandom(365)),
            );
            if (gay) {
            ...
            lawyer.workLocation = findSiteInSameCity(
              founder.base?.city,
              SiteType.courthouse,
            );
    ...
    _Question(FounderBackgroundStage.recentLife, "For the last year or so, I've been...", [
      _Option(
        'corporate_thief',
        "stealing from Corporations.  I know they're hiding the truth.",
  ...
  for (_Question question in questions) {
    ...
    while (true) {
      ...
      if (choice >= Key.a && choice <= Key.e) {
        final answer = question.answers[choice - Key.a];
        answer.callback();
        recordFounderBackgroundChoice(
          founderId: founder.id,
          stage: question.stage,
          choiceId: answer.id,
          stageOrder: questions.indexOf(question) + 1,
  ...
  switch (recruits) {
    case Recruits.gang:
      for (int i = 0; i < 4; i++) {
        Creature recruit = Creature.fromId(
